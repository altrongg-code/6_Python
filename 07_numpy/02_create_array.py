...
print(f"0으로 채워서 배열 생성: {np.zeros(5, dtype='int64')}") # int 타입으로 생성
print(f"1으로 채워서 배열 생성: {np.ones((2,3))}") # float 타입으로 생성
print(f"특정 값으로 채워서 배열 생성: {np.full(5, 7)}")
print(f"0부터 9까지 정수를 생성: {np.arange(10)}")
print(f"0부터 100까지 5등분하여 배열 생성: {np.linspace(0, 100, 5, dtype='int')}")
